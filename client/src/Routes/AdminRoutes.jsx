...
import ListBookings from '../Admin/pages/Reports/Reports'
...
import AdminUsersTheatres from '../Admin/pages/Reports/Reports'
import Complaints from '../Admin/pages/Complaint/Complaint'

const AdminRoutes = () => {
    return (
        <Routes>
            {/* <Route path="Reports" element={<ListBookings />} /> */}
            ...
            <Route path="Reports" element={<AdminUsersTheatres />} />
